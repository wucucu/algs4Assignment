...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        return new SlopeToThisPointOrder();
    }

    private class SlopeToThisPointOrder implements Comparator<Point> {
        private final Point p;

        public SlopeToThisPointOrder() {
            this.p = Point.this;
        }
    ...
    public static void main(String[] args) {
        ...
        // System.out.print(a.slopeTo(b) < a.slopeTo(a));
    }
}